...
namespace GraphicsEngineSpace
{
	...
	bool ShaderManager::CompileAllShader()
	{
		...
		CreateVertexShader("Shader/LegacyStaticShader/LegacyStaticVS.hlsl", "main", "vs_5_0", "LegacyStaticVS", InputLayoutDesc::LegacyStatic, 4, nullptr);
		...
		// 아무 것도 사용 하지 않는 경우
		CreatePixelShader("Shader/LegacyStaticShader/LegacyStaticPS.hlsl", "main", "ps_5_0", "LegacyStaticPS", nullptr);
		// Diffuse Map만 사용하는 경우
		CreatePixelShader("Shader/LegacyStaticShader/LegacyStaticPS.hlsl", "main", "ps_5_0", "LegacyStaticDiffusePS", model_MacroPS_1);
		// Diffuse + Normal Map만 사용하는 경우
		CreatePixelShader("Shader/LegacyStaticShader/LegacyStaticPS.hlsl", "main", "ps_5_0", "LegacyStaticNormalPS", model_MacroPS_2);
