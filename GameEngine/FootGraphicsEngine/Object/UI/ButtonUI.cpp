			...
			switch (state)
			{
				...
				case ButtonState::PRESS:
				{
					...
					batch->Draw(defaultTex->GetMapSRV().Get(), buttonSize, nullptr,
						DirectX::Colors::DarkGray, 0.0f, { 0.f, 0.f }, DirectX::SpriteEffects_None, screenPos.z);
				...
				case ButtonState::ENTER:
				{
					...
					// 텍스쳐가 없으면.. color 마스크를 바꿔보자..
					batch->Draw(defaultTex->GetMapSRV().Get(), buttonSize, nullptr,
						DirectX::Colors::LightGray, 0.0f, { 0.f, 0.f }, DirectX::SpriteEffects_None, screenPos.z);
